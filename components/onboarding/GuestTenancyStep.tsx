...
export type PropertyOption = { propertyId: string; name: string };
...
export function GuestTenancyStep(props: {
  ...
  return (
    <div className="rounded-2xl border bg-card p-8 shadow-xl">
      <h2 className="text-xl font-semibold mb-1">Register Your Tenancy</h2>
      ...
      <div className="space-y-4">
        ...
        {!!tenancyInfo && !tenancyError && (
          <p className="text-sm text-muted-foreground">{tenancyInfo}</p>
        )}
